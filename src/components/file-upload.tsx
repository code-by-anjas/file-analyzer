...
export function FileUpload({
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      console.log(err);
      setError("Something went wrong while generating the result.");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <>
          ...
          <Card className={cn("w-full", className)}>
            ...
            <CardContent className='space-y-4'>
              ...
              >
                <input {...getInputProps()} />
                <UploadCloudIcon className='h-10 w-10 text-muted-foreground mx-auto mb-4' />
          ...
          <Button onClick={async () => await onSubmit()} disabled={isLoading}>
            {isLoading ? (
